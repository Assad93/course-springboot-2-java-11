package com.projetosamir.course.config;
...
import com.projetosamir.course.entities.enums.OrderStatus;
import com.projetosamir.course.repositories.CategoryRepository;
import com.projetosamir.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, u1); // z = horario UTC  pc do brasil -3h
